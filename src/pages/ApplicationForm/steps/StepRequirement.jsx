...
const CheckCircle = () => (
  <svg
    ...
    stroke="currentColor"
    strokeWidth="2.2"
    className="text-[#0F4C81] flex-shrink-0 mt-0.5"
  >
...
const SECTIONS = [
  ...
  },
  {
    ...
    mandatory: ["Full Name", "Phone Number", "Relation to student"],
    optional: ["Additional emergency contacts (you can add more)"],
  },
  {
    step: "Step 3",
  ...
  },
  {
    ...
    mandatory: ["Personal Statement (typed, double-spaced)"],
    optional: [],
  },
  {
    step: "Step 5",
  ...
  },
  {
    ...
    mandatory: [
      ...
      "The following fees will be charged to candidates who wish to enroll in and pursue the Global Healthcare Workforce Mobility Program",
      "Global Healthcare Workforce Mobility Certification and Skill-Gap Training Fee",
      "Visa, Sponsorship Processing, and Immigration Attorney Fee",
      "Professional Licensing, Registration, and Documentation Processing Fee",
      "Government and third-party charges are not included in the above fees. UK Government fees, professional regulatory authority charges, university fees, examination fees, biometric charges, visa application fees, Immigration Health Surcharge, certificate charges, and external agency fees shall be payable separately by the candidate at actual cost.",
      "Payment of these fees does not guarantee admission, professional registration, visa approval, sponsorship, employment, or placement. All outcomes remain subject to eligibility, document verification, assessment, regulatory requirements, employer selection, and approval by the relevant authorities.",
      "To complete the above process, it may cost approximately £5,000.00 GBP.",
    ],
    optional: [],
  },
  {
                ...
                <div className="mb-4">
                  ...
                  <ul className="space-y-2">
                    {sec.mandatory.map((item) => (
                      <li
                        key={item}
                        className="flex items-start gap-2 text-sm text-[#0D1B2E]"
                      >
                        <StarIcon />
                        <span>{item}</span>
                      </li>
